...
# Symlink google-chrome-beta to google-chrome so the script finds it easily if it searches for "google-chrome"
# However, the script checks 'google-chrome' and 'chromium'.
RUN ln -sf /usr/bin/google-chrome-beta /usr/bin/google-chrome
